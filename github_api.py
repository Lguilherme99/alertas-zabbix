...
ZABBIX_ALERTS_FILE = "/opt/API/Historico_alertas.txt"  # Caminho do arquivo de alertas do Zabbix
...
shutil.copy(ZABBIX_ALERTS_FILE, os.path.join(REPO_DIR, "historico_alertas.txt"))

# Navegue para o diretório do repositório
os.chdir(REPO_DIR)

# Adicione e commite as alterações
subprocess.run(["git", "add", "historico_alertas.txt"])
